...
6. Download script: `https://github.com/MFDGaming/ubuntu-in-termux.git`
...
```curl -LSs "https://raw.githubusercontent.com/GhostMaster69-dev/ubuntu-in-termux/refs/heads/master/ubuntu-in-termux.sh" | bash```
